          ...
          بيانات الحجز
                ...
                <div class="row row-sm mg-b-20">
                    <div class="input-group col-md-4">
                        ...
                        </div><input class="form-control fc-datepicker" name="apt_date" placeholder="MM/DD/YYYY" type="text">
                    </div>
                    ...
                    <div class="input-group col-md-4">
                        ...
                        </div><input class="form-control fc-datepicker" name="apt_time" placeholder="00:00 type="time">
                    </div>
