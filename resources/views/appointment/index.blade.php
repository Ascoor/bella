                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-id="{{ $item->id }}"
                                            data-client_id="{{ $item->client->client_name }}" data-toggle="modal"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('appointments.store') }}" method="POST"
                    ...
                    <div class="modal fade" id="edit_apt_modal" tabindex="-1" role="dialog"
                        aria-labelledby="editAptModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content modal-content-demo">
                                <div class="modal-header">
                                    <h6 class="modal-title">حذف الحجز</h6>
                                ...
                                <form action="appointments/update" method="post" autocomplete="off">
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-lg">
                                            ...
                                            <input class="form-control mg-b-20" name="client_id" namm="cliemt_name"
                                                type="text">
                                        </div>
                                        <input type="hidden" name="edited_by" id="edited_by" type="text">

                                        <div class="row row-sm">
                                            <div class="col-lg">
                                                <p class="mg-b-10">البريد الإلكترونى للعميل</p>
                                                <input class="form-control mg-b-15" id="" name name="email"
                                                    type="email">
                                            </div>
                                        </div>
                                    </div>
                                        <div class="row row-sm mg-b-20">
                                            <div class="input-group col-md-4">
                                                ...
                                                <input class="form-control fc-datepicker" id="apt_date" name="apt_date"
                                            ...
                                            <div class="input-group col-md-4">
                                                ...
                                                <input class="form-control fc-datepicker" name="apt_time" id="apt_time"
                                            ...
                                            <div class="input-group col-md-4">
                                                ...
                                                <input class="form-control" id="client_phone" aria-label="Phone Number"
                                                    type="tel">
                                            </div>
                                        </div>
                                        <div class="row row-sm mg-b-20">
                                            <div class="col-lg-4">
                                                <p class="mg-b-10">حالة الحجز</p>
                                                <select class="form-control select2-no-search" id="status"
                                                    name="status">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <select class="form-control select2-no-search" name="doctor_id">
                                                <option label="Choose one">
                                                <option value="{{ $item->doctor->id }}" selected>
                                                    {{ $item->doctor->name }}</option>

                                            </select>
                                        </div>

                                        <div class="row"> <span>
                                                <button class="btn btn-primary text-light" type="submit">تحديث</button>
                                            </span>
                                        </form>
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="delete_apt_modal" tabindex="-1" role="dialog"
                aria-labelledby="deleteAptModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                        ...
                        <form action="appointments/destroy" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <select class="form-control" name="client_id" id="client_id" type="text" readonly>
                                    <option></option>
                                </select>
                            </div>
