                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                            data-id="{{ $item->id }}" data-doctor_id="{{ $item->doctor->id }}" data-status="{{ $item->status }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                                <form action="appointments/update" method="post" autocomplete="off">
                                    ...
                                    <div class="row row-sm">
                                        <div class="col-sm">
                                            ...
                                            <input class="form-control mg-b-20" id="client_name"
                                                type="text">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="apt_datetime" name="apt_datetime">
                    </div>
...
<script>$('#edit_apt_modal').on('show.bs.modal', function (event) {
