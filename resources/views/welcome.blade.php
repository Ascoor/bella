...
>>>>>>> c1cd9fd6c4ccd0517c8b77cd5c58138f2226a98d
    <!-- Google Fonts -->
    ...
    <style>
        ...
        .slide-image {
            width: 100%; /* Change to 100% to make the image responsive */
            height: 625px;
            object-fit: cover;
            /* this property ensures the image is resized without distortion */
        }
...
<body class="h-100 text-center text-white"
      style="background: url('img/bg-pattern.png?h=88366d218f2eda574d88b27e4cb4169d'), linear-gradient(to left, #7b4397, #dc2430);">
<div class="container">
    <header class="mb-auto p-3" style="font-family: monospace;
>>>>>>> c1cd9fd6c4ccd0517c8b77cd5c58138f2226a98d
font-size:16px;">
            ...
            <form method="post" action="{{ route('appointments.submitForm') }}">
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="tel" id="client_phone" name="client_phone" class="form-control"
                           placeholder="إدخل رقم الجوال، مثال: +971 5XX XXXX" required>
                </div>
                <div class="form-group mt-4">
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="datetime-local" name="apt_datetime" id="apt_datetime"
                           class="form-control @error('apt_datetime') is-invalid @enderror" required>
                </div>
...
=======
            <div id="carouselExampleIndicators" class="carousel slide mt-6" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset('img/slid6.png') }}" class="d-block slide-image" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('img/slid2.jpg') }}" class="d-block slide-image" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('img/slid3.jpg') }}" class="d-block slide-image" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('img/slid4.jpg') }}" class="d-block slide-image" alt="...">
                    </div>
                </div>
    ...
    <br/>
    <p>
        <span>Copyrights © <a class="afoot" href="https://wwww.ask-ar.com"> Ask-ar T.S </a> all rights reserved ©
            2023 </span>
    </p>
</div>
