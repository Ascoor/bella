...
<head>
    ...
    <link href="{{ URL::asset('assets/plugins/fullcalendar/fullcalendar.min.css') }}"
        rel="stylesheet">
...
background: url('../img/bg-pattern.png?h=88366d218f2eda574d88b27e4cb4169d'), linear-gradient(to left, #7b4397, #130e2d)">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    @auth
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span
                                    class="badge bg-danger">{{ auth()->guard('doctor')->user()->unreadNotifications()->count() }}</span>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <ul class="list-group list-group-flush text-center">
                                        <blade
                                            foreach|%20(auth()-%3Eguard(%26%2339%3Bdoctor%26%2339%3B)-%3Euser()-%3EunreadNotifications%20as%20%24notification)%20%3Ca%20class%3D%26%2334%3Bd-flex%20p-3%20border-bottom%20notification-item%26%2334%3B%20href%3D%26%2334%3B%7B%7Broute(%2526%252339%253Bdoctor_dashboard.show_appointment%2526%252339%253B%252C%2520%2524notification-%253Edata%255B%2526%252339%253Bappointment_id%2526%252339%253B%255D)%7D%7D%26%2334%3B%20data-id%3D%26%2334%3B%7B%7B%2524notification-%253Eid%7D%7D%26%2334%3B%3E>

                                            <li class="list-group-item">
                                                <a href="{{ route('doctor_dashboard.show_appointment', $notification->data['appointment_id']) }}"
                                                    data-id="{{ $notification->id }}">
                                                    تم تأكيد حجز جديد من
                ...
                @if(auth()->guard('doctor')->check())
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light">دكتور
                            /{{ auth()->guard('doctor')->user()->name }}</a>
                    </li>
    ...
    <script src="{{ URL::asset('assets/plugins/select2/js/select2.full.min.js') }}">
    </script>
