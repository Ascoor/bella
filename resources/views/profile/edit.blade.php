								...
								<div class="pl-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											<img alt="" src="{{URL::asset('uploads/users/'.$user->photo)}}"><a class="fas fa-camera profile-edit" name='photo' href="JavaScript:void(0);"></a>
										</div>
										<div class="d-flex justify-content-between mg-b-20">
											<div>
												<h5 class="main-profile-name"> {{ $user->name }}</h5>
												<p class="main-profile-name-text">{{ $user->profile->nickname }}</p>
											</div>
										</div>
										<!-- <h6>Bio</h6>
								...
								<div class="tab-content border-left border-bottom border-right border-top-0 p-4">
									...
									<div class="tab-pane" id="settings">
                                        <form role="form" method="POST" action="profile">
                                            ...
                                            <div class="form-group">
                                                <label for="Email">المسمى بالنظام</label>
                                                <input type="text" value="{{ $user->profile->postion }}" name="postion" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="Email">المنصب</label>
                                                <input type="text" value="{{ $user->profile->nickname }}" name="nickname" class="form-control">
                                            </div>
                                            <div class="form-group">
											...
											<div class="form-group">
												<label for="RePassword">اعد كتابة كلمة السر</label>
